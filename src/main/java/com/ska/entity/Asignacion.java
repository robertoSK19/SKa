...
public class Asignacion {
	...
	public DEquipo getDequipo() {
		return dequipo;
	}
	public void setDequipo(DEquipo dequipo) {
	...
	public Asignacion(Long id_asignacion, String nombre_consultor, Date fecha_asignacion, float costo, String letra,
			String usuario, DEquipo dequipo, EstatusRecurso estatusrecurso) {
		super();
		this.id_asignacion = id_asignacion;
		this.nombre_consultor = nombre_consultor;
		this.fecha_asignacion = fecha_asignacion;
